...
class PCConfigurator {
    ...
    updateSummary() {
        ...
        performanceEl.textContent = performance > 0 ? `${performance}/10` : '-/10';

        // Actualizar medidor de calidad-precio
        qualityFill.style.width = `${valueScore}%`;
        qualityValue.textContent = `${valueScore}%`;
